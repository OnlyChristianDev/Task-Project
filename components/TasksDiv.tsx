    ...
    return(
        <>
            <div className="bg-white p-3 shadow-2xl h-[500px] rounded-lg w-96">
                ...
                <div>
                    <div className="bg-[#F2F4F7] h-32 flex items-center justify-center rounded-lg"> </div>
                    <div className="bg-[#F2F4F7] mt-5 h-32 flex items-center justify-center rounded-lg"> </div>
                    <div className="bg-[#F2F4F7] mt-5  h-32 flex items-center justify-center rounded-lg"> </div>
                </div>
            </div>
        </>
